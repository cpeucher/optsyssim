...
% low pass filtering the driving signals. It is assumed that only the -x
% polarisations of the input signal is modulated. The output signal is
% polarised along -x.
%
% -------------------------------------------------------------------------
% FUNCTION CALL:
