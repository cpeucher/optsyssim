function sig = tx_ook_rz33(params)
% 33% RZ-OOK transmitter
%
% -------------------------------------------------------------------------
% DESCRIPTION:
% -------------------------------------------------------------------------
% This function generates an ideal RZ-OOK signal with 33% duty cycle.
...
% Vpi.
% The pulse carver is biased at a maximum of the Mach-Zehnder modulator
% response (2Vpi) and driven with a peak-to-peak voltage difference between
% the two driving signals equal to 2Vpi.
%
% -------------------------------------------------------------------------
% FUNCTION CALL:
% -------------------------------------------------------------------------
