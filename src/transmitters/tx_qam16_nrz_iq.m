...
% I/Q modulator.
% The driving signals are PAM-4 that have been generated by summing two
% PAM-2 signals (historical implementation for optical transmitter, not
% requiring a high-speed DAC).
