function sig = tx_ook_rz67(params)
% 67% RZ-OOK transmitter
%
% -------------------------------------------------------------------------
% DESCRIPTION:
% -------------------------------------------------------------------------
% This function generates an ideal RZ-OOK signal with 67% duty cycle
...
% Vpi.
% The pulse carver is biased at a minimum of the Mach-Zehnder modulator
% response (Vpi) and driven with a peak-to-peak voltage difference between
