function sig = tx_ook_rz50(params)
% 50% RZ-OOK transmitter
%
% -------------------------------------------------------------------------
% DESCRIPTION:
% -------------------------------------------------------------------------
% This function generates an ideal RZ-OOK signal with 50% duty cycle.
% The transmitter consists of a CW laser followed by a Mach-Zehnder data 
% modulator and a Mach-Zehnder pulse carver. The generated signal is ideal
% in the sense that the extinction ratios of the data modulator and pulse
% carvers are infinite, and chirp-free modulation is applied.
...
% Vpi.
% The pulse carver is biased at quadrature point of the Mach-Zehnder 
% modulator response (1.5*Vpi) and driven with a peak-to-peak voltage 
% difference between the two driving signals equal to Vpi.
%
% -------------------------------------------------------------------------
% FUNCTION CALL:
% -------------------------------------------------------------------------
