...
% Save data
% -------------------------------------------------------------------------
result_file_name = ['data_evm_ber_snr_awgn_qpsk'  '.mat'];
...
% BER vs SNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_ber_vs_snr_qpsk_gray';
hfig = figure('Name',fig_name);
% yyaxis left
...
% BER vs EVM
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_ber_vs_evmmax_qpsk';
...
% EVM vs SNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_evm_vs_snr_qpsk';
hfig = figure('Name',fig_name);
% yyaxis left
...
% EVM vs OSNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_evm_vs_osnr_qpsk';
hfig = figure('Name',fig_name);
% yyaxis left
