...
% Save data
% -------------------------------------------------------------------------
result_file_name = ['data_evm_ber_snr_awgn_qam16'  '.mat'];
...
% SER vs SNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_ser_vs_snr_qam16';
...
% BER vs SNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_ber_vs_snr_qam16_gray';
hfig = figure('Name',fig_name);
% yyaxis left
...
% BER vs EVM
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_ber_vs_evmmax_qam16';
...
% EVM vs SNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_evm_vs_snr_qam16';
hfig = figure('Name',fig_name);
% yyaxis left
...
% EVM vs OSNR
% -------------------------------------------------------------------------
fig_name = 'fig_dsp_evm_vs_osnr_qam16';
hfig = figure('Name',fig_name);
% yyaxis left
