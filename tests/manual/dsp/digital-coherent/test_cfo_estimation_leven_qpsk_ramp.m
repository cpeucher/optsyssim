...
cfo_estimation_block_length = 32;%1000;
...
% CFO estimation
% -------------------------------------------------------------------------
[cfo_estimate_block, cfo_estimation_delay_func_block] = cfo_estimation_leven(symbs_rx,cfo_estimation_mpower,cfo_estimation_sample_delay_block,cfo_estimation_block_length);
% CFO estimation with block averaging
[cfo_estimate_point, cfo_estimation_delay_func_point] = cfo_estimation_leven(symbs_rx,cfo_estimation_mpower,cfo_estimation_sample_delay_point,1);
