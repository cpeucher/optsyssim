...
% CFO estimation
% -------------------------------------------------------------------------
[cfo_estimate_fir, cfo_estimation_delay_func_block] = cfo_estimation_leven(symbs_rx,mpower,sample_delay_block,block_length);
% CFO estimation with FIR running averaging
[cfo_estimate_point, cfo_estimation_delay_func_point] = cfo_estimation_leven(symbs_rx,mpower,sample_delay_point,1);
