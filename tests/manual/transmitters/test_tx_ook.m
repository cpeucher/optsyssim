...
params_scope.display_interval = [0 32/symbol_rate];
params_scope.save.emf = 0;
params_scope.name = 'Waveform - OOK RZ 33%';
...
params_osa.name = 'Optical spectrum - OOK RZ 33%';
...
params_eye.name = 'Eye diagram - OOK RZ 33%';
...
% OOK RZ 50% transmitter

params_scope.visualisers = {'power'};
params_scope.name = 'Waveform - OOK RZ 50%';
meas_scope(sig.x,params_scope);
% Oscilloscope
...
params_osa.save.emf = 0;
params_osa.save.jpg = 0;
params_osa.name = 'Optical spectrum - OOK RZ 50%';
meas_osa(sig,params_osa);
% Optical spectrum analyser
...
params_eye.save.display_baseline = 1;
params_eye.colour_grade = 0;
params_eye.name = 'Eye diagram - OOK RZ 50%';
meas_eye(sig,params_eye);
% Eye diagram
...
% OOK RZ 67% transmitter.

params_scope.visualisers = {'power'};
params_scope.name = 'Waveform - OOK RZ 67%';
meas_scope(sig.x,params_scope);
% Oscilloscope
...
params_osa.save.emf = 0;
params_osa.save.jpg = 0;
params_osa.name = 'Optical spectrum - OOK RZ 67%';
meas_osa(sig,params_osa);
% Optical spectrum analyser
...
params_eye.save.display_baseline = 1;
params_eye.colour_grade = 0;
params_eye.name = 'Eye diagram - OOK RZ 67%';
meas_eye(sig,params_eye);
% Eye diagram
...
params_scope.visualisers = {'power'};
params_scope.name = 'Waveform - OOK NRZ';
meas_scope(sig.x,params_scope);
% Oscilloscope
...
params_osa.save.emf = 0;
params_osa.save.jpg = 0;
params_osa.name = 'Optical spectrum - OOK NRZ';
meas_osa(sig,params_osa);
% Optical spectrum analyser
...
params_eye.save.display_baseline = 1;
params_eye.colour_grade = 0;
params_eye.name = 'Eye diagram - OOK NRZ';
meas_eye(sig,params_eye);
% Eye diagram
